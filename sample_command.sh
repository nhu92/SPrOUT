...
python 01_exons_assembly.py -t 64 -r1 01x02x03.R1.fastq -r2 01x02x03.R2.fastq \
	-p 01x02x03 -g gene.list.txt -m 50targetfiles.fasta \
...
while read line; do python pick_match_list.py family298_refs_50genes/${line} 01x02x03_ref_family/${line} 01x02x03.order_candidates.txt; done < gene.list.txt
...
python 02_exon_trees.py -t 64 -p 01x02x03 -r 01x02x03_ref \
        -e 01x02x03_exon \
        --output_dir 01x02x03_fam_phylo

# Step 3: Distance Matrix Calculation
python 03_distance_matrices.py -t 64 -p 01x02x03 --threshold 1 \
        --input_dir 01x02x03_fam_phylo \
        --output_dir 01x02x03_fam_matrix
